...
namespace DBConexionLINQ
{
    ...
    partial void DeleteProducts(Products instance);
		...
		public ConexionDBDataContext() : 
				base(global::DBConexionLINQ.Properties.Settings.Default.NorthwindConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public int EliminarProducto([global::System.Data.Linq.Mapping.ParameterAttribute(Name="ID", DbType="Int")] System.Nullable<int> iD)
		{
		...
		public ISingleResult<LeerProductoResult> LeerProducto()
		{
